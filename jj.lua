...
MiniGit.get_buf_data = function(buf_id)
  ...
  return {
    ...
    in_progress = buf_cache.in_progress,
  }
end
...
H.ensure_git_subcommands = function()
  ...
  add_twoword('remote',
    { 'add', 'get-url', 'prune', 'remove', 'rename', 'rm', 'set-branches', 'set-head', 'set-url', 'show', 'update' })
  ...
  add_twoword('submodule',
    { 'absorbgitdirs', 'add', 'deinit', 'foreach', 'init', 'set-branch', 'set-url', 'status', 'summary', 'sync', 'update' })
